	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				-- NOTE: This is in order to set some defaults for telescope to use when executing its actions
				local telescope = require("telescope.builtin")
				local defaultConfig = require("telescope.themes").get_ivy(vim.tbl_extend("force", {}, {
					initial_mode = "normal",
				}))

				-- Find references for the word under your cursor.
				map("grr", function()
					telescope.lsp_references(defaultConfig)
				end, "[G]oto [R]eferences")

				-- Jump to the implementation of the word under your cursor.
				--  Useful when your language has ways of declaring types without an actual implementation.
				map("gri", function()
					telescope.lsp_implementations(defaultConfig)
				...
				map("grd", function()
					telescope.lsp_definitions(defaultConfig)
				...
				map("gO", function()
					telescope.lsp_document_symbols(defaultConfig)
				end, "Open Document Symbols")

				-- Fuzzy find all the symbols in your current workspace.
				--  Similar to document symbols, except searches over your entire project.
				map("gW", function()
					telescope.lsp_dynamic_workspace_symbols(defaultConfig)
				...
				map("grt", function()
					telescope.lsp_type_definitions(defaultConfig)
