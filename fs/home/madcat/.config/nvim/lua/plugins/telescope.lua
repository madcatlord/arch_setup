return {
	...
	config = function()
		...
		require("telescope").setup({
			...
			extensions = {
				-- WARN: This probably does nothing. It's copied from chatGPT, hoping it would improve the sorting algo, but I dont think it does. I only mean fzf specifically here
				fzf = {
					fuzzy = true, -- enable fuzzy matching
					override_generic_sorter = true, -- use fzf sorter for generic searches
					override_file_sorter = true, -- use fzf sorter for files (find_files, oldfiles, buffers)
					case_mode = "smart_case", -- case-insensitive unless uppercase letters used
				},
				["ui-select"] = {
		...
		vim.keymap.set(
			"n",
			"<leader>wh",
			"<cmd>Telescope fd cwd=$HOME hidden=true theme=ivy<CR>",
			{ desc = "Find Files from Home" }
		)
		vim.keymap.set(
			"n",
			"<leader>wr",
			"<cmd>Telescope fd cwd=/ hidden=true theme=ivy<CR>",
